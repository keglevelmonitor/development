...
class PopupManagerMixin:    
    ...
    def _open_wiring_diagram_popup(self):
        try:
            ...
            if has_pdf:
                # Save Copy Button
                ttk.Button(footer_frame, text="Save PDF Copy...", 
                           command=lambda: self._save_wiring_pdf(pdf_path, popup)).pack(side="left", padx=5)
    ...
    def _save_wiring_pdf(self, source_path, parent_popup):
        """Helper to copy the wiring PDF file to a user-selected location."""
        from tkinter import filedialog
        
        default_filename = "KegLevel_Wiring_Diagram.pdf"
        ...
        dest_path = filedialog.asksaveasfilename(
            parent=parent_popup,
            title="Save Wiring Diagram Copy",
